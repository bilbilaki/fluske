class PaymentKeyModel {
  ...
  String? phonepayRedirectUrl;
  dynamic phonepayStatus;
  ...
  PaymentKeyModel.fromJson(Map<String, dynamic> json) {
    ...
    phonepayMerchantId = json['phonepaymerchantid'];
    phonepaySaltKey = json['phonepaysaltkey'];
    phonepayRedirectUrl = json['phonepayredirect_url'];
    phonepayStatus = json['phonepaystatus'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['phonepaymerchantid'] = this.phonepayMerchantId;
    data['phonepaysaltkey'] = this.phonepaySaltKey;
    data['phonepayredirect_url'] = this.phonepayRedirectUrl;
    data['phonepaystatus'] = this.phonepayStatus;
    return data;
  }
}
