...
class _PayuPaymentState extends State<PayuPayment> {
  ...
  PayuWebCheckoutModel({required key, required salt, required txnId, required phone, required String amount, required String productName, required firstName, required email, required String udf1, required String udf2, required String udf3, required String udf4, required String udf5, required String successUrl, required String failedUrl, required String baseUrl}) {}
}

extension on PayUWebCheckout {
  void doPayment({required BuildContext context, required payuWebCheckoutModel}) {}
}

class PayUWebCheckout {
  static var EVENT_PAYMENT_SUCCESS;
  
  static var EVENT_PAYMENT_ERROR;

  void clear() {}
  
  void on(event_payment_success, void Function(Map<String, dynamic> response) handlePaymentSuccess) {}
}
