...
class _RazorPaymentState extends State<RazorPayment> {
  ...
  void initState() {
    ...
    _razorpay.on(Razorpay.EVENT_PAYMENT_ERROR, _handlePaymentError as void Function(PaymentSuccessResponse response));
    _razorpay.on(Razorpay.EVENT_EXTERNAL_WALLET, _handleExternalWallet as void Function(PaymentSuccessResponse response));
  }
...
extension on Razorpay {
  void on(event_payment_success, void Function(PaymentSuccessResponse response) handlePaymentSuccess) {}
}
...
class Razorpay {
  ...
  static var EVENT_EXTERNAL_WALLET;
}
