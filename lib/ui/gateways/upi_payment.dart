...
extension on UpiIndia {
  getAllUpiApps({required bool mandatoryTransactionId}) {}
}

class UpiApp {
  Uint8List icon =Uint8List(8);
...
class UpiPaymentStatus {
  static Object SUCCESS=Object();
}

class UpiIndia {
  Future<UpiResponse> ({required UpiApp app, required String receiverUpiId, required String receiverName, required String transactionRefId, required String transactionNote, required double amount}) {}
  
   startTransaction({required UpiApp app, required String receiverUpiId, required String receiverName, required String transactionRefId, required String transactionNote, required double amount}) {}
}
