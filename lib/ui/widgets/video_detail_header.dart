...
import 'package:fluske/models/user_profile_model.dart';
...
import '../../player/youtubeTrailer.dart';
...
class VideoDetailHeaderState extends State<VideoDetailHeader>
  ...
  void _onTapPlay() {
    if (widget.videoDetail!.type == DatumType.T) {
      ...
      var subtitles = episodeUrl![0].subtitles.toJson().length > 0
          ? Subtitles1.fromJson(episodeUrl![0].subtitles)
          : '';
    ...
    if (canWatch) {
      ...
      if (trailerUrl == null) {
        ...
        if (trailerUrl.substring(0, 23) == 'https://www.youtube.com' ||
            trailerUrl.substring(0, 16) == 'https://youtu.be') {
          var router = new MaterialPageRoute(
            builder: (BuildContext context) => new YoutubePlayerMovieTrailer(
                id: widget.videoDetail!.id,
                type: widget.videoDetail!.type,
                url: trailerUrl),
          );
          ...
          var router = new MaterialPageRoute(
            builder: (BuildContext context) => new PlayerMovieTrailer(
              id: widget.videoDetail!.type == DatumType.T
                  ? widget.videoDetail!.seasons![newSeasonIndex].id
                  ...
                  child: widget.videoDetail!.rating == null
                      ...
                      : Row(
                          ...
                          children: [
                            Container(
                              padding: EdgeInsets.only(
                                  left: 3.5, right: 3.5, top: 0.0, bottom: 3.0),
